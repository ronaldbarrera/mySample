...
var VariablesGrid = declare("ec.fisa.widget.rules.VariablesGrid", [FisaEnhancedGrid], {
	tabId:"",
	pageScopeId:"",
	...
	postMixInProperties:function(){
		...
		this.structure=[[{'name': 'Nombre de Variable', 'field': 'prompt','width':'150px','editable':false,'noresize':true}]];
		var ctrlr = ec.fisa.controller.utils.getPageController(this.tabId, this.pageScopeId);
		this.store=ctrlr.variablesStore;
		if(ctrlr.dataKey!=null&&ctrlr.dataKey.t=="V"){
