...
var UserTransactionGrid = declare("ec.fisa.widget.transaction.UserTransactionGrid", [EnhancedGrid], {
	tabId:"",
	pageScopeId:"",
	...
	postMixInProperties:function(){
		...
		var layout = [[  {name: 'Codigo', field: 'code',width:'60px', hidden: true},
				         {name: this.appName, field: 'appName',width:'400px'}
				     ]];
