...
var GroupTransactionGrid = declare("ec.fisa.widget.transaction.GroupTransactionGrid", [EnhancedGrid], {
	tabId:"",
	pageScopeId:"",
	...
	postMixInProperties:function(){
		...
		var layout = [[  {name: 'roleId', field: 'roleId',width:'60px', hidden: true},
		                 {name: this.appName, field: 'name',width:'400px'},
		                 {name: 'appId', field: 'appId',width:'60px', hidden: true},
