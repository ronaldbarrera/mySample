define([
	...
	"dojo/dom-style",
	"dojo/_base/sniff",
	"dojo/text!./templates/FileInputAuto.html",
...
function(declare, lang, fx, win, domStyle, has, template, FileInput, ioIframe){
	...
	=====*/
var FileInputAuto = declare("ec.fisa.widget.file.FileInputAuto", FileInput, 
	{
...
//		console.debug('_handleSend');
	...
	_matchValue: function(){
		this.inherited(arguments);
		this.inputNode.value = this.fileInput.value.replace("C:\\fakepath\\", "");
	}
});
