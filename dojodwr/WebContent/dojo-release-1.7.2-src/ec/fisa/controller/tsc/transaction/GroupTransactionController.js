define([ "dojo/_base/kernel", 
	...
	var GroupTransactionController = declare("ec.fisa.controller.tsc.transaction.GroupTransactionController", BaseController, {
		...
		cancelUserRoleImpl:function(){		
			...
			GroupTransactionControllerDWR.cancelUserRoleImpl(this.tabId, this.pageScopeId, callObj);		
