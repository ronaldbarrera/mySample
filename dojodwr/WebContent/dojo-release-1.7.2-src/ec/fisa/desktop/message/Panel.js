define([
		...
		"dojo/text!ec/fisa/desktop/message/templates/Panel.html",
		"dojox/html/entities"
	], function(_Widget, _Templated, declare, connect, domConstruct, on, DialogSimple,template){

		return declare("ec.fisa.desktop.message.Panel", [_Widget, _Templated], {
			_errorPanel:null,
			_warnPanel:null,
			_infoPanel:null,
			...
			createDetailLink:function(container,msgDetail){
				var anchor = domConstruct.create("span",{innerHTML:'Ver Detalle'},container);
