define( [ "./_base",
          ...
          "dojo/_base/declare",
          "dojo/number",
          "dojo/text!./templates/OutputText.html",
  		  "./_MvcMixin"],
		function(_widgetBase,_Widget, _Templated, declare,number,template, MvcMixin) {
				return declare("ec.fisa.mobile.widget.OutputText", [ _Widget, _Templated, MvcMixin ], {
				readOnly : true,
				_componentNode : null,
				styleClass:"",
				password:false,
