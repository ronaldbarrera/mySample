define([
	...
	"dojo/dom-style",
	"dojo/_base/sniff",
	"dojo/text!./resources/FileMobileInputAuto.html",
	"ec/fisa/mobile/widget/file/FileMobileInput",
	"dojo/io/iframe"
], 
function(declare, lang, fx, win, domStyle, has, template, FileInput, ioIframe){

var FileInputAuto = declare("ec.fisa.mobile.widget.file.FileMobileInputAuto", FileInput, 
	{
	// summary:
